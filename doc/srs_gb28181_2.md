...
### 接入方式
#### 1. sip 信令与媒体
  在SRS内部实现了gb28181常用的信令，可以对接GB28181 IPC, NVR,以及28181下级域平台 主要信register, message, invite,bye. query caltalog。  
...
#### 2.仅接收28181媒体流
   停用内置sip功能，只接收28281设备或平台的媒体流数据，然后转换成rtmp流输出，接收媒体流可以使用一个固定端口，或者随机分配端口，
