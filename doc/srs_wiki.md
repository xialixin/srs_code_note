...
lang=EN-US>Edge</span>提供访问时回源机制，在<span lang=EN-US>CDN/VDN</span>等流众多的应用场景中有重大意义，
<span lang=EN-US>forward/ingest</span>方案会造成大量带宽浪费。同时，<span lang=EN-US>SRS</span>的<span
...
style='font-family:宋体'>商业版（</span><span lang=EN-US>BMS</span><span
style='font-family:宋体'>）简介</span></h3>

<p class=MsoNoSpacing style='text-indent:21.0pt'><span style='font-family:宋体;
color:black;background:white'>光有优秀的流媒体服务器，只仅仅具备了整个</span><span lang=EN-US
style='color:black;background:white'>CDN</span><span style='font-family:宋体;
color:black;background:white'>系统的很小的一部分，要建设一套能够服务百万流级别的</span><span lang=EN-US
style='color:black;background:white'>CDN</span><span style='font-family:宋体;
color:black;background:white'>分发系统，光有</span><span lang=EN-US style='color:black;
background:white'>SRS/BMS</span><span style='font-family:宋体;color:black;
background:white'>还不够。以下是基于</span><span lang=EN-US style='color:black;
background:white'>BMS</span><span style='font-family:宋体;color:black;background:
white'>构建</span><span style='font-family:"微软雅黑",sans-serif;color:black'>直播<span
lang=EN-US>CDN</span>源站结构图，还不包括技术相对简单的采集端和播放端部分，</span></p>

<p class=MsoNoSpacing><span lang=EN-US><img border=0 width=511 height=343
id="图片 14" src="srs_wiki.files/image012.jpg"></span></p>

<p class=MsoNoSpacing style='text-indent:21.0pt'><span style='font-family:"微软雅黑",sans-serif;
color:black'>其中：</span></p>
...
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>基本接口（<span lang=EN-US>Basic</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，提供的涉及运营等的基本接口，如计费、监控、调度等基础性接口；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>碧池（<span lang=EN-US>Bitch</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，为<span
lang=EN-US>BMS</span>动态配置子系统，可以从业务系统读取配置，依据更新机制主动更新配置，碧池使用<span lang=EN-US>http-api</span>和外部对接，可以支持任何符合条件的配置存储和管理方式；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>不卡（<span lang=EN-US>Bocar</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，<span
lang=EN-US>BMS</span>的源站集群子系统，打通了真正的分布式<span lang=EN-US>CDN</span>源站关键环节，使得<span
lang=EN-US>CDN</span>源站能分布在各地。不卡对外使用<span lang=EN-US>http-api</span>，可以对接到符合标准的业务系统，如元数据管理等；请参阅：《你不太了解的观止云分发之二：源站集群》</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>闪电（<span lang=EN-US>Bott</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，<span
lang=EN-US>BMS</span>的转码子系统，对接观止云大规模实时转码集群；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>HLS+</span></strong><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>，<span lang=EN-US>BMS</span>提供的流式<span
lang=EN-US>HLS</span>功能，具有回源量小、系统简单、排错容易、防盗链、低延迟等优势。请参阅：《手机直播延时直降<span
lang=EN-US>90% HLS+</span>横空出世》</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>BIG</span></strong><strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，<span
lang=EN-US>BMS</span>大数据子系统</span></strong><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>，承载整个分发系统可追踪日志和重要的服务数据；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>HLS-CUP(hls-concurrency-upstream)</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，<span
lang=EN-US>BMS</span>提供的并发回源技术，解决网络情况不佳时、跨国传输时丢包严重时等等的回源问题；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>BAR</span></strong><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>，应用层智能路由，在<span lang=EN-US>CDN</span>的多层结构中，多层边缘回源在选择上层服务器时根据整个链路智能回源；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>DNS</span></strong><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>，观止云非阻塞<span lang=EN-US>DNS</span>；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>录制（<span lang=EN-US>Record</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，观止云大规模实时流录制子系统；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>时移（<span lang=EN-US>Time-shift</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，观止云直播时移系统；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;
color:black'>延时播出（<span lang=EN-US>Delay</span>）</span></strong><span
style='font-size:10.5pt;font-family:"微软雅黑",sans-serif;color:black'>，观止云延时播出子系统；</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
24.0pt;text-indent:-18.0pt;background:white'><span lang=EN-US style='font-size:
10.0pt;font-family:Symbol;color:black'>·<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><strong><span lang=EN-US style='font-size:10.5pt;font-family:
"微软雅黑",sans-serif;color:black'>P2P</span></strong><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>，观止云通用平台<span lang=EN-US>P2P</span>分发子系统。请参阅：《大直播时代，<span
lang=EN-US>P2P</span>才是降低成本的必杀技》</span></p>

<p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:12.0pt;margin-left:
0cm;line-height:15.75pt;background:white'><span style='font-size:10.5pt;
font-family:"微软雅黑",sans-serif;color:black'>从<span lang=EN-US>CDN</span>的结构图中可看出一个完善的运营级直播<span
lang=EN-US>CDN</span>系统的极度复杂性，举一个实际例子：</span></p>

<p class=MsoNoSpacing><strong><span style='font-family:"微软雅黑",sans-serif;
color:black'>非阻塞<span lang=EN-US>DNS</span>：</span></strong><span
style='font-family:宋体'>这个虽然比较简单，但是对于直播分发效果的影响确是很大。如果服务器回源或者调用接口时是域名，譬如</span><span
lang=EN-US>DRM</span><span style='font-family:宋体'>回调客户的</span><span lang=EN-US>API</span><span
style='font-family:宋体'>是个域名地址，那么就需要</span><span lang=EN-US> DNS</span><span
style='font-family:宋体'>，解析域名到</span><span lang=EN-US>IP</span><span
style='font-family:宋体'>地址，是调用</span><span lang=EN-US>gethostbyname</span><span
style='font-family:宋体'>实现，这个是有网络</span><span lang=EN-US>IO</span><span
style='font-family:宋体'>的，发包——这个做过服务器就知道，会阻塞当前进程。</span><span lang=EN-US>SRS</span><span
style='font-family:宋体'>和</span><span lang=EN-US> NGINX</span><span
style='font-family:宋体'>都存在这个大坑，然而</span><span lang=EN-US>SRS</span><span
style='font-family:宋体'>填这个坑只用了</span><span lang=EN-US>1</span><span
style='font-family:宋体'>个工作日，但</span><span lang=EN-US>NGINX</span><span
style='font-family:宋体'>要搞定这个就稍微有点难度了。</span></p>
...
lang=EN>&nbsp;&nbsp;&nbsp; </span><span style='font-family:宋体'>观止云</span> <span
style='font-family:宋体'>（</span><span lang=EN>SRS</span><span style='font-family:
宋体'>开源作者目前所在公司）</span></p>
